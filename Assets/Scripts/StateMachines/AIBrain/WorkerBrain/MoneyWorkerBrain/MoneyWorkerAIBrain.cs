...
public class MoneyWorkerAIBrain : MonoBehaviour
{
    ...
    [BoxGroup("Public Variables")] public Transform CurrentTarget;

    #endregion

    #region Serilizable Variables

    [BoxGroup("Serializable Variables")] [SerializeField]
    ...
    [ShowInInspector] private WorkerAITypeData _workerTypeData;
    ...
    [ShowInInspector] private Vector3 waitPos;

    #endregion

    #region Worker Game Variables

    [ShowInInspector] private int _currentStock = 0;
    ...
    private void GetReferenceStates()
    {
        ...
        Debug.Log("_workerTypeData.MaxSpeed"+_workerTypeData.MaxSpeed);
