...
//
//         public SoldierAttack(SoldierAIBrain soldierAIBrain,NavMeshAgent navMeshAgent,Animator animator)
//         {
...
//             {
//                 Debug.Log(" Isdead " +_soldierAIBrain.DamageableEnemy.IsDead);
...
//             if (_timer <= 0)
//             {
//                 //_soldierAIBrain.GetObject(PoolObjectType.PistolBullet);
//                 _timer = 0.2f;
//             }
//         }
